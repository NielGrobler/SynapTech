...
describe('requestCollaboration.js Module Tests', () => {
	let dom;
	let roleSelect;
	let otherText;
	let otherLabel;
	...
	it('should hide otherText and otherLabel initially', () => {
		expect(otherText.style.display).toBe('none');
		expect(otherLabel.style.display).toBe('none');
	});

	// it('should show otherText and otherLabel when "Other" is selected', () => {
	...
	it('should hide otherText and otherLabel when a role other than "Other" is selected', () => {
...
//this has no file thus no coverage LOL